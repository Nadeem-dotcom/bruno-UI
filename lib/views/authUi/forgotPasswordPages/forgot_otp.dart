...
import 'package:bruno/views/authUi/forgotPasswordPages/reset_password.dart';
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            haveAccount(),
            const Spacer(),
            AuthButton(txt: 'Continue', onTap: () =>Navigator.push(context, MaterialPageRoute(builder: (context) => const ResetPassword(),))),
